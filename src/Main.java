...
public class Main {
    public static void main(String[] args) {
        ...
        if ( humanAge >= 2 && humanAge <= 6 )
            ...
            System.out.print ( ", то пока сказать нечего" );
        ...
        if ( passangerCount > trainCapacity )
            System.out.print ( ", то вагон полностью забит" );
        else if ( passangerCount > seatingCapacity && passangerCount <= trainCapacity )
        ...
        int secondNumber = 34;
        int thirdNumber = 34;
        System.out.print ( "\n Между числами " + firtNumber + "," + secondNumber + "," + thirdNumber );
        if ( firtNumber > secondNumber && firtNumber > thirdNumber )
            System.out.print ( ", большее " + firtNumber );
        else if ( secondNumber > firtNumber && secondNumber > thirdNumber )
            System.out.print ( ", большее " + secondNumber );
        else
            System.out.print ( ", большее " + thirdNumber );
    }
}
